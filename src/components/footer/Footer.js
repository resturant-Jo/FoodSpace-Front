		...
		<div class="container">
			<div class="row text-center text-xs-center text-sm-left text-md-left">
				...
				<div class="col-xs-12 col-sm-4 col-md-4">
					<h5>Our Mission</h5>
					<ul class="list-unstyled quick-links">
            <p style={{color:"white", fontFamily:"sans serif"}}> Our mission is to help people and communities enjoy moments that matter through technology, starting with an integrated food-delivery service that puts people's happiness and satisfaction at the core of its business. </p>
					</ul>
				</div>
				<div class="col-xs-12 col-sm-4 col-md-4">
					<h5>Quick links</h5>
